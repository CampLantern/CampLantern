...
- **keywords:** Room, roomName, estate_, 로비, 낚시터, 사냥터, 존 분할, zone, 샤딩, sharding, 마스터 클라이언트, 서버 권한, authoritative, 파티 연속성, 오프라인 방문, StartSession, SceneLauncher, LobbyHarness, FishingGroundHarness, HuntZoneHarness, EstateHarness, fishing_shard, hunt_zone_a, deviceUniqueIdentifier, SaveService, PlayerState, ContentRegistry, player_save.json, persistentDataPath, JSON 저장, 즉시 저장, 저장 타이밍, OnApplicationQuit, 강제종료
